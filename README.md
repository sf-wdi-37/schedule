...
----- | ----- | ------ | ---- | ----- | ---- |
 **9:15am <br> 10:45am** | Science Fair (CF) |  [Training: ToDo App (CF)][3-2A]| [Mongoose Associations (CF)][3-3A] | Guest UX Speaker: Dassi |  [Review (BV)](https://github.com/sf-wdi-34/students-activites-api)
 ...
 **1:30pm <br> 2:45pm** | [Express Params & Routes (BV)][3-1C] |  [Mongo/Mongoose Intro (BV)][3-2C] | [Training: Book App Sprint 2 (AC)][3-3C] | [Intro Personal API (CF)][3-4C] | Personal API (CF)
